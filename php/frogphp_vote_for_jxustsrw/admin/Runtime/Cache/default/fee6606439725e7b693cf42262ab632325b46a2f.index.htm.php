...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_515c3a2ccfe681_74031536',
  'variables' => 
  array (
    '__URL__' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_515c3a2ccfe681_74031536')) {function content_515c3a2ccfe681_74031536($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="zh">
<head>
...
<body>
	<div class="wrapper">
		<form id="login-form" action="/vote/admin.php/public/checkLogin" method="post">
			<div class="loginBox">
				<div class="head">
					<h3>普通用户登入</h3>
				</div>
